...
const tokenUpgrades = [ //Name, base upgrade cost, cost scaling, total levels, effect text
    ...
    {name: "tokenUpgrade17", baseCost: 100, costScaling: 3, levels: 3, unlock: 28, reqs: 0, recList: [0], effect: "+0.5x Crate luck per level"},
    {name: "tokenUpgrade18", baseCost: 200, costScaling: 2, levels: 3, unlock: 28, reqs: 0, recList: [0], effect: "+1x RP per level"},
