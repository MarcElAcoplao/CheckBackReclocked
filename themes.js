...
function updateThemeButton(name, color, element = null){
    ...
    if(element !== null){
        ...
        document.getElementById(`themeButton${name}`).style.backgroundColor = color
        document.getElementById(`themeButton${name}`).style.borderColor = makeThemeVariableBorderColor(color)
    }
}
...
function initThemeHTML(){
    const container = document.getElementById('cssVariablesContainer')
    const colorInput = document.getElementById('colorInput')
...
function displayThemeSetting(i, directlySet = true){
    ...
    if(directlySet) document.getElementById(`themeSetting${i}`).innerHTML = text
    else return text
}
...
function useThemeSlot(i){
   ...
   document.getElementById (`savedTheme${i}`).innerHTML = makeSavedThemeText(i)
}
...
function initThemeControlHTML(){
    const container = document.getElementById('themeControlContainer')
